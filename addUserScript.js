		        ...
		        $.ajax({
		            ...
		            success: function (party) {
		                if (party.action == 'CREATE') {
							...
							$("#ehrIds").append(formName +" "+ formSurname +": "+ ehrId+"</br>");
		                }
		            },
		            error: function(err) {
...
function loadAdd(){
	...
	$("#ehrIds").append("Ana Ambrozic: e1b61c7e-30ee-4da9-9bbf-2ee869cfa731</br>");
$("#ehrIds").append("Borut Bajc: 3650b121-4465-4f19-bdf0-1da056bdf401</br>");
$("#ehrIds").append("Ciril Cankar: e50e6880-2c78-4384-943c-efb9231e1379</br>");
